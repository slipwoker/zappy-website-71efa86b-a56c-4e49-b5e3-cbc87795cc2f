    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חיים אליקים משרד עורכי דין ונוטריון משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '71efa86b-a56c-4e49-b5e3-cbc87795cc2f',
                    name: data.name || '',
                    email: data.email || '',
